...
internal class SecureStorageSDK18 : SecureStorage {
    ...
    override fun init(context: Context): Boolean {
        ...
        try {
            kpGenerator =
                KeyPairGenerator.getInstance(KEY_ALGORITHM_RSA, KEYSTORE_PROVIDER_ANDROID_KEYSTORE)
        ...
        try {
            ...
            if (android.os.Build.VERSION.SDK_INT < 23) {
                ...
                val keyInfo = keyFactory.getKeySpec<KeyInfo>(privateKey, KeyInfo::class.java)
